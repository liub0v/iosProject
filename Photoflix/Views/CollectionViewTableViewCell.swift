...
extension CollectionViewTableViewCell: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        APICaller.shared.getMovie(with: titleName + "trailer") {[weak self] result in
            ...
            case .success(let videoElement):
                ...
                let viewModel = TitlePreviewViewModel(titleName: titleName, youTubeVideo: videoElement, overview: titleOverview)
    ...
    func collectionView(_ collectionView: UICollectionView, contextMenuConfigurationForItemAt indexPath: IndexPath, point: CGPoint) -> UIContextMenuConfiguration? {
        let config = UIContextMenuConfiguration(identifier: nil, previewProvider: nil) {[weak self] _ in
            let addAction = UIAction(title: "Add to watch list", subtitle: nil, image: nil, identifier: nil, discoverabilityTitle: nil,   state: .off) { _ in
                self?.addTitleAt(indexPath: indexPath)
            }
