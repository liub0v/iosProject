...
//  Photoflix
//
//  Created by Liubov Kurets on 08/10/2022.
//
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        APICaller.shared.getMovie(with: titleName) { [weak self] result in
            ...
            case .success(let videoElement):
                self?.delegate?.searchResultViewControllerDidTapItem(TitlePreviewViewModel(titleName: titleName, youTubeVideo: videoElement, overview: title.overview ?? ""))
